<template>
  <div class="list">
    ...
    <div class="content">
      <el-table v-loading="loading" style="width: 100%" :data="policylawList" :header-cell-style="{
      ...
      >
        ...
        <el-table-column label="政策法规标题" align="left" width="530" prop="title"/>
        <el-table-column label="发布时间" align="left" prop="publishDatetime">
