  ...
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="orderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button v-no-more-click size="mini" type="text" icon="el-icon-edit"
...
<script>
import { listOrder4Audit, getOrder, auditOrder } from "@/api/sale/order";
...
export default {
  ...
  created() {
    this.getList();
    this.getQueryData("query_order").then((res) => {
  ...
  methods: {
    ...
    handleMaterialSelected(list) {
      if (list && list.length > 0) {
        ...
        this.scmSaleOrderDetailList[this.currentRowIndex].materialId =
          this.material.id;
        this.scmSaleOrderDetailList[this.currentRowIndex].materialName =
          this.material.name;
        this.scmSaleOrderDetailList[this.currentRowIndex].materialCode =
          this.material.code;
        this.scmSaleOrderDetailList[this.currentRowIndex].materialModel =
          this.material.model;
        this.scmSaleOrderDetailList[
          this.currentRowIndex
        ].materialSpecification = this.material.specification;
        this.scmSaleOrderDetailList[this.currentRowIndex].materialUnit =
          this.material.unit;
      }
      this.materialSelectOpen = false;
    },
