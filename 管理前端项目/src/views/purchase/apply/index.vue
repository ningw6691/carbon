    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button v-no-more-click type="success" plain icon="el-icon-edit" size="mini" :disabled="single"
          @click="handleUpdate" v-hasPermi="['purchase:apply:edit']">修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button v-no-more-click type="danger" plain icon="el-icon-delete" size="mini" :disabled="multiple"
          @click="handleDelete" v-hasPermi="['purchase:apply:remove']">删除</el-button>
      </el-col>
        ...
        <el-row :gutter="10" class="mb8">
          <el-col :span="1.5">
            <el-button v-no-more-click v-if="form.auditStatus != '1' && form.applyStatus != '1'" type="primary"
              icon="el-icon-plus" size="mini" @click="handleAddScmPurchaseApplyDetail">添加
            </el-button>
          </el-col>
          <el-col :span="1.5">
            <el-button v-no-more-click v-if="form.auditStatus != '1' && form.applyStatus != '1'" type="danger"
              icon="el-icon-delete" size="mini" @click="handleDeleteScmPurchaseApplyDetail">删除
            </el-button>
          </el-col>
        </el-row>
